...
- [-] 2. Implement lexical analysis (Lexer)
  ...
  - [ ] 2.5 Write unit tests for lexer edge cases
    - Test invalid character handling
    - Test whitespace and newline processing
    - Test position tracking accuracy
    - _Requirements: 2.2, 2.4_

- [ ] 3. Implement syntax analysis (Parser and AST)
  - [ ] 3.1 Create AST node classes
  ...
  - [ ] 3.3 Write property test for parsing round-trip
    - **Property 2: Parsing Round-Trip Consistency**
    - **Validates: Requirements 3.5**
  
  - [ ] 3.4 Write unit tests for parser error handling
